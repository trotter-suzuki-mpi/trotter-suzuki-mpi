...
CC2Kernel::CC2Kernel(double *_p_real, double *_p_imag, double *_external_pot_real, double *_external_pot_imag, double _a, double _b, int matrix_width, int matrix_height, int _halo_x, int _halo_y, int *periods,
#ifdef HAVE_MPI
                     MPI_Comm _cartcomm,
#endif
                     bool _imag_time):
