...
// Class methods
CPUBlock::CPUBlock(float *_p_real, float *_p_imag, float *_external_pot_real, float *_external_pot_imag, float _a, float _b, int matrix_width, int matrix_height, int _halo_x, int _halo_y, MPI_Comm _cartcomm):
    a(_a),
    b(_b),
    sense(0),
    halo_x(_halo_x),
