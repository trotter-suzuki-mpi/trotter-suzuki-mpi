...
class CPUBlock : public ITrotterKernel
{
    ...
    private :
        ...
        struct _nx_data_env_2_t;
        static void _smp__ol_process_band_2(::CPUBlock::_nx_data_env_2_t *const __restrict__ args);
        ...
        static void _smp__ol_process_sides_0(::CPUBlock::_nx_data_env_0_t *const __restrict__ args);
        struct _nx_data_env_1_t;
        static void _smp__ol_process_sides_1(::CPUBlock::_nx_data_env_1_t *const __restrict__ args);
...
{
    for (size_t idx = start_offset, peer = idx + stride;
        idx < width;
        idx += 2 , peer += 2)
    {
    ...
    for (size_t y = 1;
        ...
        ++y)
    {
        for (size_t idx = y * stride + (start_offset + y) % 2, peer = idx + stride;
            idx < y * stride + width;
            idx += 2 , peer += 2)
        {
            float tmp_real = p_real[idx];
...
static void block_kernel_horizontal(size_t start_offset, size_t stride, size_t width, size_t height, float a, float b, float *p_real, float *p_imag)
{
    for (size_t y = 0;
        ...
        ++y)
    {
        for (size_t idx = y * stride + (start_offset + y) % 2, peer = idx + 1;
            idx < y * stride + width - 1;
            idx += 2 , peer += 2)
        {
            float tmp_real = p_real[idx];
            float tmp_imag = p_imag[idx];
...
struct CPUBlock::_nx_data_env_0_t
{
        unsigned long int __tmp_0_0;
        unsigned long int __tmp_1_0;
        float __tmp_2_0;
        float __tmp_3_0;
        const float *__tmp_4_0;
        const float *__tmp_5_0;
        float *__tmp_6_0;
        float *__tmp_7_0;
        int __tmp_8_0;
        unsigned long int __tmp_9_0;
        unsigned long int __tmp_10_0;
        unsigned long int __tmp_11_0;
        unsigned long int __tmp_12_0;
        unsigned long int __tmp_13_0;
        ::CPUBlock *_this;
};
void ::CPUBlock::_smp__ol_process_sides_0(_nx_data_env_0_t *const __restrict__ _args)
{
    const unsigned long int ___tmp_0_0 = _args->__tmp_0_0;
    const unsigned long int ___tmp_1_0 = _args->__tmp_1_0;
    float ___tmp_2_0 = _args->__tmp_2_0;
    float ___tmp_3_0 = _args->__tmp_3_0;
    const float *___tmp_4_0 = _args->__tmp_4_0;
    const float *___tmp_5_0 = _args->__tmp_5_0;
    float *___tmp_6_0 = _args->__tmp_6_0;
    float *___tmp_7_0 = _args->__tmp_7_0;
    int ___tmp_8_0 = _args->__tmp_8_0;
    unsigned long int ___tmp_9_0 = _args->__tmp_9_0;
    unsigned long int ___tmp_10_0 = _args->__tmp_10_0;
    unsigned long int ___tmp_11_0 = _args->__tmp_11_0;
    unsigned long int ___tmp_12_0 = _args->__tmp_12_0;
    unsigned long int ___tmp_13_0 = _args->__tmp_13_0;
    // Translation is done by the runtime
    {
        full_step_task((___tmp_0_0), (___tmp_1_0), (___tmp_2_0), (___tmp_3_0), (___tmp_4_0), (___tmp_5_0), (___tmp_6_0), (___tmp_7_0), (___tmp_8_0), (___tmp_9_0), (___tmp_10_0), (___tmp_11_0), (___tmp_12_0), (___tmp_13_0));
    }
}
struct CPUBlock::_nx_data_env_1_t
{
        unsigned long int __tmp_0_0;
        unsigned long int __tmp_1_0;
        float __tmp_2_0;
...
void ::CPUBlock::_smp__ol_process_sides_1(_nx_data_env_1_t *const __restrict__ _args)
{
    const unsigned long int ___tmp_0_0 = _args->__tmp_0_0;
    const unsigned long int ___tmp_1_0 = _args->__tmp_1_0;
    float ___tmp_2_0 = _args->__tmp_2_0;
...
void CPUBlock::process_sides(size_t read_y, size_t read_height, size_t write_offset, size_t write_height, float a, float b, const float *p_real, const float *p_imag, float *next_real, float *next_imag, float *block_real, float *block_imag)
{
    ...
    {
        const unsigned long int __tmp_0 = block_width;
        const unsigned long int __tmp_1 = block_height;
        float __tmp_2 = a;
        float __tmp_3 = b;
        const float *__tmp_4 = &p_real[read_address];
        const float *__tmp_5 = &p_imag[read_address];
        float *__tmp_6 = &next_real[write_address];
        float *__tmp_7 = &next_imag[write_address];
        int __tmp_8 = tile_width;
        unsigned long int __tmp_9 = read_width;
        unsigned long int __tmp_10 = write_width;
        unsigned long int __tmp_11 = block_read_out_address;
        unsigned long int __tmp_12 = read_height;
        unsigned long int __tmp_13 = write_height;
        {
            // SMP device descriptor
            static nanos_smp_args_t _ol_process_sides_0_smp_args = {(void (*)(void *)) _smp__ol_process_sides_0};
            ...
            if (wd != (nanos_wd_t) 0)
            {
                ...
                ol_args->__tmp_6_0 = __tmp_6;
                ol_args->__tmp_7_0 = __tmp_7;
                ol_args->__tmp_8_0 = __tmp_8;
                ol_args->__tmp_9_0 = __tmp_9;
                ol_args->__tmp_10_0 = __tmp_10;
                ol_args->__tmp_11_0 = __tmp_11;
                ol_args->__tmp_12_0 = __tmp_12;
                ol_args->__tmp_13_0 = __tmp_13;
                nanos_dependence_t _dependences[4] = {
                    {
                        (void **) &ol_args->__tmp_4_0,
                        ((char *) (((const float (*)[__tmp_9]) __tmp_4)) - (char *) ol_args->__tmp_4_0),
                        {
                            1,
                            0,
                            1,
                        ...
                        ((__tmp_12) * ((__tmp_9) * sizeof(const float)))
                    },
                    {
                        (void **) &ol_args->__tmp_5_0,
                        ((char *) (((const float (*)[__tmp_9]) __tmp_5)) - (char *) ol_args->__tmp_5_0),
                        {
                            1,
                            0,
                            1,
                    ...
                    {
                        (void **) &ol_args->__tmp_6_0,
                        ((char *) (((float (*)[__tmp_10]) __tmp_6)) - (char *) ol_args->__tmp_6_0),
                        {
                            0,
                            1,
                            1,
                        ...
                        ((__tmp_13) * ((__tmp_10) * sizeof(float)))
                    },
                    {
                        (void **) &ol_args->__tmp_7_0,
                        ((char *) (((float (*)[__tmp_10]) __tmp_7)) - (char *) ol_args->__tmp_7_0),
                        {
                            0,
                            1,
                            1,
                ...
                err = nanos_submit(wd, 4, (nanos_dependence_t *) _dependences, (nanos_team_t) 0);
                if (err != NANOS_OK)
                    nanos_handle_error(err);
            }
            else
            {
                ...
                imm_args.__tmp_5_0 = __tmp_5;
                imm_args.__tmp_6_0 = __tmp_6;
                imm_args.__tmp_7_0 = __tmp_7;
                imm_args.__tmp_8_0 = __tmp_8;
                imm_args.__tmp_9_0 = __tmp_9;
                imm_args.__tmp_10_0 = __tmp_10;
                imm_args.__tmp_11_0 = __tmp_11;
                imm_args.__tmp_12_0 = __tmp_12;
                imm_args.__tmp_13_0 = __tmp_13;
                nanos_dependence_t _dependences[4] = {
                    {
                        (void **) &imm_args.__tmp_4_0,
                        ((char *) (((const float (*)[__tmp_9]) __tmp_4)) - (char *) imm_args.__tmp_4_0),
                        {
                            1,
                            0,
                            1,
                    ...
                    {
                        (void **) &imm_args.__tmp_5_0,
                        ((char *) (((const float (*)[__tmp_9]) __tmp_5)) - (char *) imm_args.__tmp_5_0),
                        {
                            1,
                            0,
                            1,
                    ...
                    {
                        (void **) &imm_args.__tmp_6_0,
                        ((char *) (((float (*)[__tmp_10]) __tmp_6)) - (char *) imm_args.__tmp_6_0),
                        {
                            0,
                            1,
                            1,
                    ...
                    {
                        (void **) &imm_args.__tmp_7_0,
                        ((char *) (((float (*)[__tmp_10]) __tmp_7)) - (char *) imm_args.__tmp_7_0),
                        {
                            0,
                            1,
                            1,
                ...
                dyn_props.priority = 0;
                err = nanos_create_wd_and_run_compact(&_const_def.base, &dyn_props, sizeof(_nx_data_env_0_t), &imm_args, 4, (nanos_dependence_t *) _dependences, (nanos_copy_data_t *) 0, 0);
                if (err != NANOS_OK)
                    nanos_handle_error(err);
            }
        }
    ...
    write_width = tile_width - block_start - halo_x;
    {
        ...
        {
            // SMP device descriptor
            static nanos_smp_args_t _ol_process_sides_1_smp_args = {(void (*)(void *)) _smp__ol_process_sides_1};
            ...
            static struct nanos_const_wd_definition_local_t _const_def = {
                {
                    ...
                    __alignof__(_nx_data_env_1_t),
                    0,
                    1
                },
                {{
                    nanos_smp_factory,
                    &_ol_process_sides_1_smp_args
                }}
            };
            nanos_wd_dyn_props_t dyn_props = {0};
            nanos_err_t err;
            dyn_props.priority = 0;
            err = nanos_create_wd_compact(&wd, &_const_def.base, &dyn_props, sizeof(_nx_data_env_1_t), (void **) &ol_args, nanos_current_wd(), (nanos_copy_data_t **) 0);
            if (err != NANOS_OK)
                nanos_handle_error(err);
            if (wd != (nanos_wd_t) 0)
            {
            ...
            else
            {
                ...
                dyn_props.priority = 0;
                err = nanos_create_wd_and_run_compact(&_const_def.base, &dyn_props, sizeof(_nx_data_env_1_t), &imm_args, 4, (nanos_dependence_t *) _dependences, (nanos_copy_data_t *) 0, 0);
                if (err != NANOS_OK)
                    nanos_handle_error(err);
            }
        }
...
struct CPUBlock::_nx_data_env_2_t
{
        unsigned long int __tmp_0_0;
        unsigned long int __tmp_1_0;
        float __tmp_2_0;
...
void ::CPUBlock::_smp__ol_process_band_2(_nx_data_env_2_t *const __restrict__ _args)
{
    const unsigned long int ___tmp_0_0 = _args->__tmp_0_0;
    const unsigned long int ___tmp_1_0 = _args->__tmp_1_0;
    float ___tmp_2_0 = _args->__tmp_2_0;
...
void CPUBlock::process_band(size_t read_y, size_t read_height, size_t write_offset, size_t write_height, float a, float b, const float *p_real, const float *p_imag, float *next_real, float *next_imag, int inner, int sides)
{
    ...
    else
    {
        ...
        if (inner)
        {
            for (size_t block_start = block_width - 2 * halo_x;
                block_start < tile_width - block_width;
                block_start += block_width - 2 * halo_x)
            {
                ...
                size_t write_width = block_width - 2 * halo_x;
                {
                    ...
                    {
                        // SMP device descriptor
                        static nanos_smp_args_t _ol_process_band_2_smp_args = {(void (*)(void *)) _smp__ol_process_band_2};
                        _nx_data_env_2_t *ol_args = (_nx_data_env_2_t *) 0;
                        nanos_wd_t wd = (nanos_wd_t) 0;
                        struct nanos_const_wd_definition_local_t
                        {
                                nanos_const_wd_definition_t base;
                        ...
                        static struct nanos_const_wd_definition_local_t _const_def = {
                            {
                                ...
                                __alignof__(_nx_data_env_2_t),
                                0,
                                1
                            },
                            {{
                                nanos_smp_factory,
                                &_ol_process_band_2_smp_args
                            }}
                        };
                        nanos_wd_dyn_props_t dyn_props = {0};
                        nanos_err_t err;
                        dyn_props.priority = 0;
                        err = nanos_create_wd_compact(&wd, &_const_def.base, &dyn_props, sizeof(_nx_data_env_2_t), (void **) &ol_args, nanos_current_wd(), (nanos_copy_data_t **) 0);
                        if (err != NANOS_OK)
                            nanos_handle_error(err);
                        if (wd != (nanos_wd_t) 0)
                        {
                        ...
                        else
                        {
                            ...
                            dyn_props.priority = 0;
                            err = nanos_create_wd_and_run_compact(&_const_def.base, &dyn_props, sizeof(_nx_data_env_2_t), &imm_args, 4, (nanos_dependence_t *) _dependences, (nanos_copy_data_t *) 0, 0);
                            if (err != NANOS_OK)
                                nanos_handle_error(err);
                        }
                    }
...
CPUBlock::CPUBlock(float *_p_real, float *_p_imag, float _a, float _b, size_t _tile_width, size_t _tile_height, int _halo_x, int _halo_y)
    : orig_real(_p_real), orig_imag(_p_imag), a(_a), b(_b), tile_width(_tile_width), tile_height(_tile_height), halo_x(_halo_x), halo_y(_halo_y), sense(0) 
{
...
void CPUBlock::run_kernel_on_halo()
{
    ...
    else
    {
        ...
        sides = 1;
        size_t block_start;
        for (block_start = 128u - 2 * halo_y;
            block_start < tile_height - 128u;
            block_start += 128u - 2 * halo_y)
        {
            process_band(block_start, 128u, halo_y, 128u - 2 * halo_y, a, b, p_real[sense], p_imag[sense], p_real[1 - sense], p_imag[1 - sense], inner, sides);
        }
        inner = 1;
        sides = 1;
        process_band(0, 128u, 0, 128u - halo_y, a, b, p_real[sense], p_imag[sense], p_real[1 - sense], p_imag[1 - sense], inner, sides);
        inner = 1;
        sides = 1;
...
{
    int inner = 1, sides = 0;
    for (size_t block_start = 128u - 2 * halo_y;
        block_start < tile_height - 128u;
        block_start += 128u - 2 * halo_y)
    {
        process_band(block_start, 128u, halo_y, 128u - 2 * halo_y, a, b, p_real, p_imag, next_real, next_imag, inner, sides);
    }
}
void CPUBlock::initialize_MPI(MPI_Comm _cartcomm, int _start_x, int _inner_end_x, int _start_y, int _inner_start_y, int _inner_end_y)
{
    ...
    int count = inner_end_y - inner_start_y;
    int block_length = halo_x;
    int stride = tile_width;
    MPI_Type_vector(count, block_length, stride, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), &verticalBorder);
    MPI_Type_commit(&verticalBorder);
    count = halo_y;
    block_length = tile_width;
    stride = tile_width;
    MPI_Type_vector(count, block_length, stride, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), &horizontalBorder);
    MPI_Type_commit(&horizontalBorder);
}
void CPUBlock::start_halo_exchange()
{
    int offset = (inner_start_y - start_y) * tile_width;
    MPI_Irecv(p_real[1 - sense] + offset, 1, verticalBorder, neighbors[2], 1, cartcomm, req);
    MPI_Irecv(p_imag[1 - sense] + offset, 1, verticalBorder, neighbors[2], 2, cartcomm, req + 1);
    offset = (inner_start_y - start_y) * tile_width + inner_end_x - start_x;
    MPI_Irecv(p_real[1 - sense] + offset, 1, verticalBorder, neighbors[3], 3, cartcomm, req + 2);
    MPI_Irecv(p_imag[1 - sense] + offset, 1, verticalBorder, neighbors[3], 4, cartcomm, req + 3);
    offset = (inner_start_y - start_y) * tile_width + inner_end_x - halo_x - start_x;
    MPI_Isend(p_real[1 - sense] + offset, 1, verticalBorder, neighbors[3], 1, cartcomm, req + 4);
    MPI_Isend(p_imag[1 - sense] + offset, 1, verticalBorder, neighbors[3], 2, cartcomm, req + 5);
    offset = (inner_start_y - start_y) * tile_width + halo_x;
    MPI_Isend(p_real[1 - sense] + offset, 1, verticalBorder, neighbors[2], 3, cartcomm, req + 6);
    MPI_Isend(p_imag[1 - sense] + offset, 1, verticalBorder, neighbors[2], 4, cartcomm, req + 7);
}
void CPUBlock::finish_halo_exchange()
{
    MPI_Waitall(8, req, statuses);
    int offset = 0;
    MPI_Irecv(p_real[sense] + offset, 1, horizontalBorder, neighbors[0], 1, cartcomm, req);
    MPI_Irecv(p_imag[sense] + offset, 1, horizontalBorder, neighbors[0], 2, cartcomm, req + 1);
    offset = (inner_end_y - start_y) * tile_width;
    MPI_Irecv(p_real[sense] + offset, 1, horizontalBorder, neighbors[1], 3, cartcomm, req + 2);
    MPI_Irecv(p_imag[sense] + offset, 1, horizontalBorder, neighbors[1], 4, cartcomm, req + 3);
    offset = (inner_end_y - halo_y - start_y) * tile_width;
    MPI_Isend(p_real[sense] + offset, 1, horizontalBorder, neighbors[1], 1, cartcomm, req + 4);
    MPI_Isend(p_imag[sense] + offset, 1, horizontalBorder, neighbors[1], 2, cartcomm, req + 5);
    offset = halo_y * tile_width;
    MPI_Isend(p_real[sense] + offset, 1, horizontalBorder, neighbors[0], 3, cartcomm, req + 6);
    MPI_Isend(p_imag[sense] + offset, 1, horizontalBorder, neighbors[0], 4, cartcomm, req + 7);
    MPI_Waitall(8, req, statuses);
}
